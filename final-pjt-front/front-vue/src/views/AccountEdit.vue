<template>
  <div style="background-color: #BDFCFE; height:800px">
    ...
    <br>
    <div class="container p-4 col-md-6 rounded-3">
      <div class="p-2" style="background-color:#FBFEAB;">
        <h1>회원정보 수정</h1>
        ...
        <b-button pill variant="primary" @click="userSubmit">수정하기</b-button>
      </div>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    userSubmit() {
      ...
      this.$store.dispatch('userEdit', payload)
    },
  }
}
</script>
